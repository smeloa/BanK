(function ($) {
    $('body').on('click', '.btn-request-api', function (e) {
        //e.preventDefault();
        //submitHandler: function(form) {
            var data = {
                ...
                "numerodeniveles": $('#niveles').val(),
                "terraza": $('#terraza').is(':checked') ? "Si" : "No",
                "areaterraza": 0,
                "vista": $('#vistaexterior').is(':checked') ? "Interior" : "Exterior",
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response !== "") {
                        ...
                        $('.direccion').text(response.features.direccion);
